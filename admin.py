...
class Register:
    def __init__(self,root):
        ...
        # ===============background image=============
        self.bg4=ImageTk.PhotoImage(file=r"/home/more/Downloads/bg3.jpg")
        label_bg4=Label(self.root,image=self.bg4)
        label_bg4.place(x=0,y=0,relwidth=1,relheight=1)


        # ===============left image=============
        self.bg5=ImageTk.PhotoImage(file=r"/home/more/Downloads/bgg.jpeg")
    ...
    def login_admin(self):
         ...
         try:
              ...
              if result:
                   ...
                   self.log_in=index.login_window(self.new_window)
