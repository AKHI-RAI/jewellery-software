...
class company_det :
    def __init__(self,root) :
      ...
      #   btnsearch.grid(row=1,column=2,padx=1)
        ...
        cp_table.place(x=0,y=50,width=700,height=350)

        scroll_x2=ttk.Scrollbar(cp_table,orient=HORIZONTAL)
        scroll_y2=ttk.Scrollbar(cp_table,orient=VERTICAL)

        self.company_table=ttk.Treeview(cp_table,column=("name","contact","email","website","address"),xscrollcommand=scroll_x2.set)
