...
class emplogin_window:
    def __init__(self,root):
        ...
        # ===============background image=============
        self.bg3=ImageTk.PhotoImage(file=r"/home/more/Downloads/bg3.jpg")
        ...
        # =============image icon===========================
        img1=Image.open(r"/home/more/Downloads/icon.png")
    ...
    def adm_login(self):
        ...
        self.admlog=index.login_window(self.new_window)
